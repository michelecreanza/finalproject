...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { alcohol: @beer.alcohol, brand: @beer.brand, img: @beer.img, name: @beer.name } }, as: :json
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { alcohol: @beer.alcohol, brand: @beer.brand, img: @beer.img, name: @beer.name } }, as: :json
    assert_response 200
  end
